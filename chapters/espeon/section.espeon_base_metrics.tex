...
A métrica é calculada com base nos \textit{traces} de interação coletados pela extensão durante a aula. O algoritmo implementado no Script segue as seguintes etapas:
