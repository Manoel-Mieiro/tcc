Esta seção apresenta as métricas utilizadas para quantificar níveis de distração dos alunos durante as aulas monitoradas. Essas métricas permitem avaliar tanto a proporção de tempo em que o estudante esteve fora da guia da aula quanto a frequência com que ocorreram mudanças de foco, oferecendo agregando elementos à observação da disperção do foco.
