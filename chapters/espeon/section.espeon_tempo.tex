...
Métrica que exibe o foco dos alunos ao longo do período de aula, segmentando a sessão em quatro intervalos iguals, os quartis.Essa abordagem permite identificar padrões de variação no engajamento — como períodos de maior atenção, momentos de queda de foco ou recuperação da participação.
