...
\begin{quote}
    A inexistência de livros levava-o a repetir (recitações-leitura) o texto tantas vezes quantas necessárias para que os alunos o decorassem (hipótese em que se poderia supor que os alunos podiam ser até analfabetos)(Lima, 1973).
\end{quote}
