...
A coleta dos dados é feita passivamente durante aulas remotas excepcionais, ministradas no CEFET/RJ, campus Maria da Graça; mediante conscentimento dos envolvidos, por meio do ESPEON. O diagrama abaixo ilustra o processo de coleta, armazenamento e processamento dos dados comportamentais.
...
Esses dados, ao final das aulas, serão compilados em um relatório de aula; que ilustra as principais métricas de atenção e engajamento numéricamente, de forma a oferecer uma avaliação de desempenho da aula ministrada. Os eventos avaliados nesse relatório estão dispostos na tabela abaixo.
