...
É descritiva porque objetiva, primeiramente, caracterizar uma população submetida a um fenômeno (aula expositiva remota), utilizando técnicas padronizadas de coleta de dados (\textit{payload} da \textit{API}), conforme prescrito por \cite{sienaMetodologiaPesquisaCientifica2024}.
